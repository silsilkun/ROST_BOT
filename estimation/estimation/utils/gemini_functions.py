"""
R.O.S.T - Gemini API 함수 (gemini_functions.py)
...
GEMINI_THINKING_BUDGET_SPATIAL = cfg.GEMINI_THINKING_BUDGET_SPATIAL
GEMINI_THINKING_BUDGET_CLASSIFY = cfg.GEMINI_THINKING_BUDGET_CLASSIFY
CATEGORY_LIST = cfg.CATEGORY_LIST
CATEGORIES = cfg.CATEGORIES
PREFER_GRASP_PTS_ANGLE = cfg.PREFER_GRASP_PTS_ANGLE
GRIPPER_ANGLE_OFFSET_DEG_CW = cfg.GRIPPER_ANGLE_OFFSET_DEG_CW
GRIPPER_ANGLE_USE_GRASP_NORMAL = cfg.GRIPPER_ANGLE_USE_GRASP_NORMAL
USE_DIRECT_TARGET_PICK = cfg.USE_DIRECT_TARGET_PICK
